...
- **Výpočet odchodu** — karta na hlavní stránce s živým odpočtem; při běžící směně počítá z Příchodu, jinak zadáš začátek ručně (pole se objeví jen když směna neběží).
...
Karta „Odchod domů" je na hlavní stránce pod píchačkami. **Když směna běží**, začátek se bere z prvního Příchodu. **Když směna neběží**, objeví se pod tlačítky pole **Začátek** pro ruční výpočet „co kdyby". Ruční začátek se neukládá.
